...
LOGGING=<true/false>
```
*_Determines whether or not log files are recorded during use. Defaults to "false". This value is stored._*
```
LOG_DIR=<Desired directory>
```
*_Sets the folder where logs, if enabled, are saved. Default is the "Logs" subdirectory. This value is stored._*
```
RM_OUTPUT
```
